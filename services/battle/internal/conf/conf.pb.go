// battle 服务配置：引用公共配置消息（含 mongo 战斗结果存储）。

// Code generated by protoc-gen-go. DO NOT EDIT.
// versions:
// 	protoc-gen-go v1.36.10
// 	protoc        v5.26.1
// source: services/battle/internal/conf/conf.proto
...
var (
	...
	file_services_battle_internal_conf_conf_proto_rawDescData []byte
)

func file_services_battle_internal_conf_conf_proto_rawDescGZIP() []byte {
	file_services_battle_internal_conf_conf_proto_rawDescOnce.Do(func() {
		file_services_battle_internal_conf_conf_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_services_battle_internal_conf_conf_proto_rawDesc), len(file_services_battle_internal_conf_conf_proto_rawDesc)))
	})
...
func file_services_battle_internal_conf_conf_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_services_battle_internal_conf_conf_proto_goTypes,
		DependencyIndexes: file_services_battle_internal_conf_conf_proto_depIdxs,
		MessageInfos:      file_services_battle_internal_conf_conf_proto_msgTypes,
	}.Build()
	File_services_battle_internal_conf_conf_proto = out.File
	file_services_battle_internal_conf_conf_proto_goTypes = nil
	file_services_battle_internal_conf_conf_proto_depIdxs = nil
}
